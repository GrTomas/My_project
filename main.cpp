    ...
    if (ar_failas == "T" || ar_failas == "t") {
        ...
        if (auto_duom == 1) {
            ...
            if (ats == "T" || ats == "t") {
                ...
                darbas_su_auto_failu("stud1000.txt", 1000);
                darbas_su_auto_failu("stud10000.txt", 10000);
                darbas_su_auto_failu("stud100000.txt", 100000);
                darbas_su_auto_failu("stud1000000.txt", 1000000);
                darbas_su_auto_failu("stud10000000.txt", 10000000);

                cout << "----------------------------------------------------" << endl;

                darbas_su_auto_failu_list("stud1000.txt", 1000);
                darbas_su_auto_failu_list("stud10000.txt", 10000);
                darbas_su_auto_failu_list("stud100000.txt", 100000);
                darbas_su_auto_failu_list("stud1000000.txt", 1000000);
                darbas_su_auto_failu_list("stud10000000.txt", 10000000);
