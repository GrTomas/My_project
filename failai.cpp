...
void darbas_su_auto_failu(string pav, int kiek) {
    ...
    cout << "Failo is " << kiek << " irasu nuskaitymo laikas naudojant vector: " << diff1.count() << endl;
    ...
    cout << kiek << " irasu suskirstymo i grupes laikas naudojant vector: " << diff2.count() << endl;


    auto end = std::chrono::high_resolution_clock::now();
    std::chrono::duration<double> diff = end - start;
    cout << kiek << " irasu darbo bendras laikas naudojant vector: " << diff.count() << endl;
